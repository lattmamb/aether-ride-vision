...
import { CreditCard as CreditCardIcon, MapPin as MapPinIcon, Search, User } from "lucide-react";
      ...
      >
        <div className="flex flex-col gap-2">
          {navLinks.map((link, index) => (
            <motion.div
              ...
              className={`py-3 ${
                isActiveRoute(link.path) ? "border-l-2 border-primary pl-2" : "pl-4"
              }`}
            >
              <Link
                to={link.path}
        ...
        >
          <div className="relative">
            <input
              type="text"
              placeholder="Search Commonwealth"
          ...
          <Link to="/dashboard">
            <Button
              ...
              className={`w-full border-primary/30 ${
                isActiveRoute("/dashboard") ? "bg-primary/20 text-white" : "text-white"
              }`}
            >
          ...
          <Button
            ...
            onClick={handleEnterCommonwealth}
          >
            Enter Commonwealth
          </Button>
        </motion.div>
        ...
        >
          ...
          <Link to="/pricing" className="bg-white/5 hover:bg-white/10 p-3 rounded-xl text-center">
            ...
            <span className="text-xs text-white/80">Mobility pricing</span>
          </Link>
        </motion.div>
      </motion.div>
    )}
